...
<html>
    ...
    <body>
      <div class="container-md">
          ...
          <p class="text-center fs-1">Veículo Cadastrado</p>
          ...
          <div class="mb-3 row">
             <label for="staticProprietario" class="col-md-2 col-form-label">Proprietário</label>
             <div class="col-md-10">
               <input type="text" readonly class="form-control-plaintext" id="staticProprietario" value="<%= request.getAttribute("proprietario") %>">
             </div>
          </div>
